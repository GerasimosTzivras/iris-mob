export const documentsMenu = [
  ...
  {
    id: 2,
    name: "Εισαγωγή εγγράφου",
    icon: "file-earmark-arrow-up",
  },
  {
    id: 3,
    name: "Νέο ενημερωτικό",
    icon: "box",
  },
  {
    id: 4,
...
export const toolsMenu = [
  {
    id: 1,
    name: "Πρωτόκολλο Εισερχομένων",
    icon: "arrow-down-left-square",
  },
  {
    id: 1,
    name: "Πρωτόκολλο Εξερχομένων",
    icon: "arrow-up-right-square",
  },

  {
    id: 1,
    name: "Λίστες υπογραφών",
    icon: "list-check",
  },
  {
    id: 1,
    name: "Λίστες αποδεκτών",
  ...
  {
    id: 1,
    name: "Επαφές Προσωπικού Φορέα",
    icon: "person-square",
  },
  {
    id: 1,
    name: "Επαφές Εκτός Ίριδα",
  ...
  {
    id: 1,
    name: "Αιτήσεις Αδειών",
    icon: "person-x-fill",
  },
  {
    id: 1,
    name: "Άδειες για υπογραφή",
    icon: "pen",
  },
  {
    id: 1,
    name: "Υπογεγραμμένες Άδειες",
    icon: "check-square",
  },
  {
    id: 1,
    name: "Καθήκοντα από αντικαταστάσεις",
    icon: "arrow-bar-left",
  },
  {
    id: 1,
    name: "Ανατιθέμενα καθήκοντα",
    icon: "arrow-bar-right",
  },
  {
    id: 1,
    name: "Ανατιθέμενες διεκπεραιώσεις",
    icon: "arrow-bar-right",
  },
];
